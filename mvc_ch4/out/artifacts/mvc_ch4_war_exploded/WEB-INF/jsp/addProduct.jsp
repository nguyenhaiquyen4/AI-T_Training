        ...
        <fieldset>
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg-2" for="manufacturer"><spring:message
                        code="addProduct.form.productManufactorer.label"/></label>
                <div class="col-lg-10">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg-2" for="unitsInStock"><spring:message
                        code="addProduct.form.productUnitsInStock.label"/></label>
                <div class="col-lg-10">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2 col-lg-2" for="unitsInOrder"><spring:message
                        code="addProduct.form.productUnitsInOrder.label"/></label>
                <div class="col-lg-10">
            ...
            <div class="form-group">
                <label class="control-label col-lg-2" for="discontinued"><spring:message
                        code="addProduct.form.productDiscontinued.label"/></label>
                <div class="col-lg-10">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <form:radiobutton path="condition1" value="New"/>New
                    <form:radiobutton path="condition1" value="Old"/>Old
                    <form:radiobutton path="condition1" value="Refurbished"/>Refurbished
                </div>
            </div>
            <div class="form-group">
